                ...
                <div className="grid grid-cols-2 gap-2">
                    {FEATURE_CARDS.map((card) => (
                        <motion.button
                            ...
                            className="flex items-center gap-2.5 p-3 rounded-[1.2rem] bg-white/[0.03] border border-white/[0.05] hover:bg-white/[0.06] transition-all text-left group"
                        >
                            ...
                            <span className="text-[11px] font-bold text-gray-300 tracking-wide uppercase whitespace-nowrap">{card.label}</span>
                        </motion.button>
                    ))}
                </div>
